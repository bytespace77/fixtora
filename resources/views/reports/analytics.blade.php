<?php
// $agents removed — team performance is now superadmin-only via $isSuperAdmin and $teamPerformance
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="team-card">
        <div class="team-head">
            <div>
                ...
                <div class="card-sub" style="margin-bottom:0">Role-based performance overview across all teams</div>
            </div>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td style="font-weight:600;color:var(--navy)">Users</td>
                    <td style="font-size:14px;font-weight:600;color:var(--navy)"><?= $teamPerformance['own']['user_count'] ?? 0 ?></td>
                    <td style="font-size:14px;font-weight:600;color:var(--navy)"><?= $teamPerformance['developer']['user_count'] ?? 0 ?></td>
                    <td style="font-size:14px;font-weight:600;color:var(--navy)"><?= $teamPerformance['admin']['user_count'] ?? 0 ?></td>
                    <td style="font-size:14px;font-weight:600;color:var(--navy)"><?= $teamPerformance['qc']['user_count'] ?? 0 ?></td>
                </tr>
                <tr>
                    <td style="font-weight:600;color:var(--navy)">Resolved</td>
                    <td style="font-size:14px;font-weight:600;color:var(--navy)"><?= $teamPerformance['own']['resolved'] ?? 0 ?></td>
                    <td style="font-size:14px;font-weight:600;color:var(--navy)"><?= $teamPerformance['developer']['resolved'] ?? 0 ?></td>
                    <td style="font-size:14px;font-weight:600;color:var(--navy)"><?= $teamPerformance['admin']['resolved'] ?? 0 ?></td>
                    <td style="font-size:14px;font-weight:600;color:var(--navy)"><?= $teamPerformance['qc']['resolved'] ?? 0 ?></td>
                </tr>
                <tr>
                    <td style="font-weight:600;color:var(--navy)">Avg Response</td>
                    <td style="font-size:13.5px;color:var(--text)"><?= $teamPerformance['own']['avg_response'] ?? '—' ?></td>
                    <td style="font-size:13.5px;color:var(--text)"><?= $teamPerformance['developer']['avg_response'] ?? '—' ?></td>
                    <td style="font-size:13.5px;color:var(--text)"><?= $teamPerformance['admin']['avg_response'] ?? '—' ?></td>
                    <td style="font-size:13.5px;color:var(--text)"><?= $teamPerformance['qc']['avg_response'] ?? '—' ?></td>
                </tr>
                <tr>
                    <td style="font-weight:600;color:var(--navy)">Load</td>
                    <td>
                        <div class="load-bar-wrap"><div class="load-bar" style="width:<?= $teamPerformance['own']['load'] ?? 0 ?>%"></div></div>
                    </td>
                    <td>
                        <div class="load-bar-wrap"><div class="load-bar" style="width:<?= $teamPerformance['developer']['load'] ?? 0 ?>%"></div></div>
                    </td>
                    <td>
                        <div class="load-bar-wrap"><div class="load-bar" style="width:<?= $teamPerformance['admin']['load'] ?? 0 ?>%"></div></div>
                    </td>
                    <td>
                        <div class="load-bar-wrap"><div class="load-bar" style="width:<?= $teamPerformance['qc']['load'] ?? 0 ?>%"></div></div>
                    </td>
                </tr>
                <tr>
                    <td style="font-weight:600;color:var(--navy)">CSAT</td>
                    <td><span class="csat-val"><?= $teamPerformance['own']['csat'] ?? '—' ?></span></td>
                    <td><span class="csat-val"><?= $teamPerformance['developer']['csat'] ?? '—' ?></span></td>
                    <td><span class="csat-val"><?= $teamPerformance['admin']['csat'] ?? '—' ?></span></td>
                    <td><span class="csat-val"><?= $teamPerformance['qc']['csat'] ?? '—' ?></span></td>
                </tr>
            </tbody>
        </table>
    </div>
